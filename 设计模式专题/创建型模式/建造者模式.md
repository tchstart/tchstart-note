...
![image](https://github.com/tchstart/tchstart-note/assets/127310524/f62be22f-e771-4eae-b86b-742c70732663)
...
![image](https://github.com/tchstart/tchstart-note/assets/127310524/3b301ed0-00c0-4457-b078-6df6555bb13e)

**创建共享单车**

生产自行车是一个复杂的过程，它包含了车架，车座等组件的生产。而车架又有碳纤维，铝合金等材质的，车座有橡胶，真皮等材质。对于自行车的生产就可以使用建造者模式。
这里Bike是产品，包含车架，车座等组件；Builder是抽象建造者，MobikeBuilder和OfoBuilder是具体的建造者；Director是指挥者。类图如下：
![image](https://github.com/tchstart/tchstart-note/assets/127310524/f619dafd-b96c-4a9c-aa7e-4b0f92259c6c)
```java
//自行车类
public class Bike {
